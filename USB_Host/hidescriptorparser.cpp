...
uint8_t ReportDescParserBase::ParseItem(uint8_t **pp, uint16_t *pcntdn) {
        ...
        switch(itemParseState) {
                case 0:
                        ...
                        break; // added to remove warning in GRSAKURA
                case 1:
                        //USBTRACE2("\r\niSz:",itemSize);
...
//        const char * const * w; // comment out to remove warning in GRSAKURA
...
//        const char * const * w; // w is unused in "output_pgm_message" in GRSAKURA
        E_Notify(pstrSpace, 0x80);
