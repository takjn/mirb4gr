...
public:
        virtual ~MouseReportParser(){}; // to remove warning in GRSAKURA
...
public:
        ...
        virtual ~KeyboardReportParser() {}; // to remove warning in GRSAKURA
...
public:
        ...
        virtual ~HIDBoot(){}; // to remove warning in GRSAKURA
...
#if defined(GRSAKURA)
        epInfo[bNumEP].epAttribs = (pep->bmAttributes);
#endif
