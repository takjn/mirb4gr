...
./Keyboard.cpp ./Display.cpp
OBJFILES = ./gr_sketch.o ./gr_common/core/HardwareSerial.o ./gr_common/core/main.o \
./gr_common/core/new.o ./gr_common/core/Print.o ./gr_common/core/Stream.o ./gr_common/core/Tone.o ./gr_common/core/utilities.o ./gr_common/core/WMath.o ./gr_common/core/WString.o ./gr_common/lib/DSP/DSP.o ./gr_common/lib/EEPROM/EEPROM.o \
./gr_common/lib/RTC/RTC.o ./gr_common/lib/RTC/utility/RX63_RTC.o ./gr_common/lib/SD/File.o ./gr_common/lib/SD/SD.o ./gr_common/lib/SD/utility/Sd2Card.o ./gr_common/lib/SD/utility/SdFile.o ./gr_common/lib/SD/utility/SdVolume.o ./gr_common/lib/Servo/Servo.o ./gr_common/lib/SoftwareSerial/SoftwareSerial.o ./gr_common/lib/SPI/SPI.o ./gr_common/lib/Stepper/Stepper.o ./gr_common/lib/Wire/Wire.o ./gr_common/lib/Wire/utility/I2cMaster.o ./gr_common/rx63n/exception_handler.o ./gr_common/rx63n/hardware_setup.o ./gr_common/core/usbdescriptors.o ./gr_common/core/usb_cdc.o ./gr_common/core/usb_core.o ./gr_common/core/usb_hal.o ./gr_common/core/wiring.o ./gr_common/core/wiring_analog.o ./gr_common/core/wiring_digital.o ./gr_common/core/wiring_pulse.o ./gr_common/core/wiring_shift.o ./gr_common/core/avr/avrlib.o ./gr_common/lib/EEPROM/utility/r_flash_api_rx600.o ./gr_common/lib/Wire/utility/twi_rx.o ./gr_common/rx63n/interrupt_handlers.o ./gr_common/rx63n/reboot.o ./gr_common/rx63n/util.o ./gr_common/rx63n/vector_table.o ./gr_common/rx63n/reset_program.o \
./USB_Host/hid.o ./USB_Host/hidboot.o ./USB_Host/hidescriptorparser.o ./USB_Host/hwDmaIf.o ./USB_Host/message.o ./USB_Host/parsetools.o ./USB_Host/r_usbh_driver.o ./USB_Host/Usb.o ./USB_Host/usbhBulk.o ./USB_Host/usbhControl.o ./USB_Host/usbhDriver.o ./USB_Host/usbhInterrupt.o ./USB_Host/usbhIsochronous.o ./USB_Host/usbhMain.o ./USB_Host/usbhPipe.o ./USB_Host/utilities/sysif.o \
./SSD1306Ascii/src/SSD1306Ascii.o \
./Keyboard.o ./Display.o
