...
./USB_Host/hid.o ./USB_Host/hidboot.o ./USB_Host/hidescriptorparser.o \
./USB_Host/hwDmaIf.o ./USB_Host/message.o ./USB_Host/parsetools.o ./USB_Host/r_usbh_driver.o \
./USB_Host/Usb.o ./USB_Host/usbhBulk.o ./USB_Host/usbhControl.o ./USB_Host/usbhDriver.o ./USB_Host/usbhInterrupt.o ./USB_Host/usbhIsochronous.o ./USB_Host/usbhMain.o ./USB_Host/usbhPipe.o ./USB_Host/usbhub.o \
./USB_Host/utilities/sysif.o \
